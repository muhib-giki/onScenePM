...
const BoardView = ({ id, setIsModalNewTaskOpen }: BoardProps) => {
    ...
    // console.log("Inside Board View: ", tasks);
            ...
            <div className="mb-3 flex w-full">
                ...
                <div className="flex w-full items-center justify-between rounded-e-lg bg-white px-5 py-4 dark:bg-dark-secondary">
                    <h3 className="flex items-center text-lg font-semibold dark:text-white">
                        {status} {" "}
                        <span
                            className="ml-2 rounded-full bg-gray-200 p-1 text-center text-sm leading-none dark:bg-dark-tertiary"
                    ...
                    <div className="flex -space-x-[6px] overflow-hidden"> 
                        {task.assignee && (
                            <Image
                                ...
                                width={30}
                                height={30}
                                className="h-8 w-8 rounded-full border-2 bordeer-white object-cover dark:border-dark-secondary"
                            />
                        )}
                        {task.author && (
                            <Image
